...
if plots==1
    ...
    fill(whisk(:,1),whisk(:,2),colorfence,'LineStyle','none')
     %This is essential in order to prevent that only the last executed plotting command is executed
    ...
    if databag==1
        plot(data1(:,1),data1(:,2),'o','MarkerFaceColor','b','MarkerEdgeColor','k','Markersize',2)
    end
    if datafence==1
        plot(data2(:,1),data2(:,2),'o','MarkerFaceColor','b','MarkerEdgeColor','k','Markersize',2)
    end
    plot(outl(:,1),outl(:,2),'hk','MarkerFaceColor','k','Markersize',1)
    plot(tukm(1),tukm(2),'.','MarkerFaceColor','w','MarkerEdgeColor','w','MarkerSize',10);
